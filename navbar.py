    ...
    if example == 1:
        ...
        with st.sidebar:
            selected = option_menu(
                ...
                options=["Home", "Comparitive Study", "Viewer Behaviour Analysis","Recommendation Page","Youtube Content Analysis","Dashboard Analytics"],  # required*
...
if selected == "Youtube Content Analysis":
    ...
    video_data['Category_id'] = pd.to_numeric(video_data['Category_id'])
